...
java -jar "../../../../clava/Clava.jar" match_param_args.lara -p input_prog_test.cpp > test_o_lara.txt
java -jar "../../../../clava/Clava.jar" fn_names_line_no.lara -p input_prog_test.cpp > test_o_lara_2.txt
java -jar "../../../../clava/Clava.jar" fill_input_4.lara -p input_prog_test.cpp > test_o_lara_3.txt
python3 read_lara_o.py
python3 read_lara_o_ip3.py
python3 get_main_code.py
python3 read_lara_o_ip4.py

java -jar "../../../../clava/Clava.jar" FunctionReplacer.lara -p input_prog_test.cpp 2>&1
