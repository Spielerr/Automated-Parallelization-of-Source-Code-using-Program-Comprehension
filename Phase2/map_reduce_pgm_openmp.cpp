...
int main()
{
    ...
    #pragma omp parallel sections
    {
        #pragma omp section
        {
            max1 = max_score(match_1_scores, match_1_len);
        }

        #pragma omp section
        {
            min1 = min_score(match_1_scores, match_1_len);
        }

        #pragma omp section
        {
            max2 = max_score(match_2_scores, match_2_len);
        }

        #pragma omp section
        {
            min2 = min_score(match_2_scores, match_2_len);
        }

        #pragma omp section
        {
            max3 = max_score(match_3_scores, match_3_len);
        }

        #pragma omp section
        {
            min3 = min_score(match_3_scores, match_3_len);
        }
    ...
    #pragma omp parallel sections
    {
        ...
        #pragma omp section
        {
            range2_ind = partition(merged_arr, n, 100, 199, range1_ind + 1);
        }
    ...
    #pragma omp parallel sections
    {
        ...
        #pragma omp section
        {
            range3_ind = partition(merged_arr, n, 200, 300, range2_ind + 1);
        }
    }
