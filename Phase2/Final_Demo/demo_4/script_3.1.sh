...
java -jar "/mnt/c/Users/mayur/Desktop/PES/PES - 6/Capstone Project/CLAVA/Clava.jar" all.lara -p testfile_demo_4.cpp > test_o_lara.txt
...
# cp testfile_demo_4.cpp ./model_3/pre_processor/inline_input.c
# bash ./model_3/query_model.sh
# cp ./model_3/output/test_output.c ./testfile_demo_4.cpp
