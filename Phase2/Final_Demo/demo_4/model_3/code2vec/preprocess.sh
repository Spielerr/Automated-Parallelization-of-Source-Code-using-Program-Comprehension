...
TRAIN_DATA_FILE=data/${DATASET_NAME}/${DATASET_NAME}.train.c2s
VAL_DATA_FILE=data/${DATASET_NAME}/${DATASET_NAME}.val.c2s
TEST_DATA_FILE=data/${DATASET_NAME}/${DATASET_NAME}.val.c2s
