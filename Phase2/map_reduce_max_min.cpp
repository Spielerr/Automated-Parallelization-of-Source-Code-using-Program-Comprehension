...
//function to find the score with the maximum count
int find_max_count(node_results *arr, int n)
{
    if(n!=0)
    {
...
//function to find the score with the minimum count
int find_min_count(node_results *arr, int n)
{
    if(n!=0)
    {
...
int main()
{
    ...
    int match_1_scores[match_1_len];
    int match_2_scores[match_2_len];
    int match_3_scores[match_3_len];
    ...
    int max_score = find_max_count(final_results, combined_length);
    int min_score = find_min_count(final_results, combined_length);

    printf("The score with the maximum count is %d\n", max_score);
    printf("The score with the maximum count is %d\n", min_score);
