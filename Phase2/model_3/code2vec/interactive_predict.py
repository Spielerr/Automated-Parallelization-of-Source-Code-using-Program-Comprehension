...
class InteractivePredictor:
    ...
    def predict(self):
        ...
        with open("p_targets.txt", "w") as f:
            f.write("noline\nnoline\n")
        # while True:
            # print(
        ...
        try:
            ...
            with open("data/c/c.train.c2v", "r") as f:
                predict_lines = f.readlines()
            for i in range(len(predict_lines)):
                predict_lines[i] = predict_lines[i].strip("\n")
            # print(predict_lines)
            with open("data/c/c.dict.c2v", "rb") as f:
        ...
        for raw_prediction, method_prediction in zip(raw_prediction_results, method_prediction_results):
            ...
            if self.config.EXPORT_CODE_VECTORS:
                ...
                l = ' '.join(map(str, raw_prediction.code_vector))
                with open("p_targets.txt", "a") as f:
                    f.write(method_prediction.original_name + " " + l + "\n")
